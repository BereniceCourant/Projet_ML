...
def write_pred(prediction):
    # write predictions to .csv file suitable for Kaggle (just make sure to add the column names)
    predictions_SVM = zip(range(len(testing_set)), prediction)
...
training_features = get_features(training_set_reduced)
...
testing_features = get_features(testing_set)

# issue predictions
predictions_SVM = list(classifier.predict(testing_features))

#Write result in file
wite_pred(predictions_SVM)
